    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _Section(label: 'Background', swatches: [
          ...
          _Section(label: 'Border', swatches: [
          ...
          _Section(label: 'Action', swatches: [
          ...
          _Section(label: 'Static', swatches: [
