    ...
    return section(classes: 'bg-transparent w-full', [
      ...
      _categoryRow(
        ...
        description:
            ...
            'input groups, dropdowns, segmented controls, and search. '
            'Token driven states for focus, error, and disabled. '
            'Localized via DievasLocalizations.',
      ...
      _categoryRow(
        ...
        count: '5',
        description:
            'Accordion, drawer, popover, menu items, and tab bars '
            'provide progressive disclosure and contextual navigation. '
