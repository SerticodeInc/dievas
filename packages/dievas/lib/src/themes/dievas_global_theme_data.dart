...
sealed class DievasGlobalThemeData implements DievasThemeData {
  ...
  static DievasElevationThemeData _buildDefaultElevation(DievasColourThemeData colors) {
    ...
    return DievasElevationThemeData(
      none: const [],
      xs: [layer(blur: DievasElevationShadowLayer.xs.blur, offsetY: DievasElevationShadowLayer.xs.offsetY, opacity: DievasOpacitySemantic.shadow1)],
      sm: [
        layer(blur: DievasElevationShadowLayer.smUpper.blur, offsetY: DievasElevationShadowLayer.smUpper.offsetY, opacity: DievasOpacitySemantic.shadow2Upper),
        layer(blur: DievasElevationShadowLayer.smLower.blur, offsetY: DievasElevationShadowLayer.smLower.offsetY, opacity: DievasOpacitySemantic.shadow2Lower),
      ],
      md: [
        layer(blur: DievasElevationShadowLayer.mdUpper.blur, offsetY: DievasElevationShadowLayer.mdUpper.offsetY, opacity: DievasOpacitySemantic.shadow2Upper),
        layer(blur: DievasElevationShadowLayer.mdLower.blur, offsetY: DievasElevationShadowLayer.mdLower.offsetY, opacity: DievasOpacitySemantic.shadow2),
      ],
      lg: [
        layer(blur: DievasElevationShadowLayer.lgUpper.blur, offsetY: DievasElevationShadowLayer.lgUpper.offsetY, opacity: DievasOpacitySemantic.shadow1Light),
        layer(blur: DievasElevationShadowLayer.lgLower.blur, offsetY: DievasElevationShadowLayer.lgLower.offsetY, opacity: DievasOpacitySemantic.shadow2),
      ],
      xl: [
        layer(blur: DievasElevationShadowLayer.xlUpper.blur, offsetY: DievasElevationShadowLayer.xlUpper.offsetY, opacity: DievasOpacitySemantic.shadow1Light),
        layer(blur: DievasElevationShadowLayer.xlLower.blur, offsetY: DievasElevationShadowLayer.xlLower.offsetY, opacity: DievasOpacitySemantic.shadow2Heavy),
      ],
    );
  }
