// Raw colour values as integers — no Flutter dependency.
// These are the atomic building blocks. Nothing in the app
// references these directly; they exist only to be aliased
...
abstract final class DievasColourPrimitives {
  ...
  // ─── Rose (critical / alert alternative)
